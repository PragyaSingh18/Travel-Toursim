...
public class BookPackage extends JFrame implements ActionListener{
    JLabel l3,l5,l6,l7,l8,l11,l12,l13,l14,l15;
    JTextField t1;
    Choice c1;
    JButton b1,b2,b3;
    BookPackage(String username){
     setBounds(600,240,1000,450);
     getContentPane().setBackground(Color.WHITE);
     setLayout(null); //if layout is not null setbound will not work..
     ...
     l11.setFont(new Font("Yu Mincho", Font.PLAIN,16));
     add(l11);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b1){
           ...
           int persons= Integer.parseInt(t1.getText()); //becoz t1.getText() gives string
            cost*=persons;
            l15.setText("Rs"+cost);
